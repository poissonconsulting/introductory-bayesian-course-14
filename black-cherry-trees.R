...
message("Call `jags_analysis` with `niters = 10^2` and `mode = 'paper'`
         How many updates are required for convergence to be achieved?")

analysis1 <- jags_analysis(model1, data = trees, niters = 10^2, mode = "paper")
...
analysis3 <- jags_analysis(model4, data = trees)
