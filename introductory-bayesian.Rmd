...
plot(analysis1, parm = c("alpha", "beta"))
```
...
(NB all the real data sets in Bayesian Population Analysis using WinBUGS have been
imported into jaggernaut)
...
fits a second-order (quadratic) polynomial on `Year`.
...
## Statistical versus Scientific Modelling
